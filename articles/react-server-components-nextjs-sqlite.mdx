...
In this post, I will show how to use Prisma to abstract database calls using its built in support for SQLite.
...
React notes app using SQLite database with Prisma
